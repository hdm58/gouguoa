...
INSERT INTO `oa_template` VALUES (11, '收款审批', 'income', 2, 0, '', '/finance/income/view/id/{action_id}', '{from_user}提交了一个『收款申请』，请及时审批', '您有一个新的『收款申请』需要处理。', '您提交的『收款申请』已被审批通过', '您在{create_time}提交的『收款申请』已于{date}被审批通过。', '您提交的『收款申请』已被驳回拒绝', '您在{create_time}提交的『无发票收款申请』已于{date}被驳回拒绝。', '{from_user}提交的『收款审批』已被审批通过并抄送给你', '{from_user}在{create_time}提交的『收款审批』已被审批通过并抄送给你，请及时查看详情。', '', 1, 1, 1733314549, 0, 0);
...
INSERT INTO `oa_flow_cate` VALUES (10, '收款', 'income', 4, 'invoice_income', 'icon-shoufeipeizhi', '', 0, 1, 0, 0, 1, 0, 1, '/finance/income/add', '/finance/income/view', 0, 1, 1, 11, 1725856435, 0);
INSERT INTO `oa_flow_cate` VALUES (11, '付款', 'payment', 4, 'ticket_payment', 'icon-bulujiesuan', '', 0, 1, 0, 0, 1, 0, 1, '/finance/payment/add', '/finance/payment/view', 0, 1, 1, 12, 1725856613, 0);
...
INSERT INTO `oa_mobile_menu` VALUES (6, '工作日志', 'icon-jilu','green', '/qiye/index/schedule', 2, 0, 1, 1733152878, 0, 0);
